    ...
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        <div className={styles.rightTop}>
          MICOLLEGO is a platform that connects people who want to learn with people who want to teach. We believe that everyone has something to teach and something to learn. Our goal is to make learning accessible to everyone, everywhere.
        </div>
        ...
        <div className={styles.line}>
            ...
            <div className={styles.tagsContainer}>
              <div className={styles.placeHolder}>Areas</div>
