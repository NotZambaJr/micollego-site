...
export default function Privacy() {
  return (
    <div className={styles.privacy}>
      ...
      <p className={styles.indent10}>Last updated: February 26, 2025</p>
      <p className={styles.indent10}>
      ...
      <h3>Definitions</h3>
      <p className={styles.indent10}>For the purposes of this Privacy Policy:</p>
      <ul className={styles.indent10}>
        <li className={styles.indent20}>
          <p className={styles.indent10}>
        ...
        <li className={styles.indent20}>
          <p className={styles.indent10}>
            ...
            this Agreement) refers to Istituto Comprensivo Bosco chiesanuova, 1,
            Via Davide Menini VR 37021.
          </p>
        </li>
        <li className={styles.indent20}>
          <p className={styles.indent10}>
        ...
        <li className={styles.indent20}>
          <p className={styles.indent10}>
            <strong>Website</strong> refers to Micollego, accessible from{" "}
            <a
              href="micollego.io"
      ...
      <ul className={styles.indent10}>
        <li className={styles.indent20}>
          <p className={styles.indent10}>Email address</p>
        </li>
        <li className={styles.indent20}>
          <p className={styles.indent10}>Usage Data</p>
        </li>
      </ul>
      <h4>Usage Data</h4>
      <p className={styles.indent10}>Usage Data is collected automatically when using the Service.</p>
      <p className={styles.indent10}>
      ...
      <ul className={styles.indent10}>
        <li className={styles.indent20}>
          ...
          <p className={styles.indent10}>Type: Session Cookies</p>
          <p className={styles.indent10}>Administered by: Us</p>
          <p className={styles.indent10}>
        ...
        <li className={styles.indent20}>
          ...
          <p className={styles.indent10}>Type: Persistent Cookies</p>
          <p className={styles.indent10}>Administered by: Us</p>
          <p className={styles.indent10}>
      ...
      <p className={styles.indent10}>The Company may use Personal Data for the following purposes:</p>
      <ul className={styles.indent10}>
        <li className={styles.indent20}>
          <p className={styles.indent10}>
      ...
      <p className={styles.indent10}>We may share Your personal information in the following situations:</p>
      <ul className={styles.indent10}>
        <li className={styles.indent20}>
      ...
      <ul className={styles.indent10}>
        <li className={styles.indent20}>Comply with a legal obligation</li>
        <li className={styles.indent20}>Protect and defend the rights or property of the Company</li>
        <li className={styles.indent20}>
        ...
        <li className={styles.indent20}>Protect against legal liability</li>
      </ul>
      ...
      <ul className={styles.indent10}>
        <li className={styles.indent20}>
          ...
          <p className={styles.indent10}>Mouseflow service may collect information from Your device.</p>
          <p className={styles.indent10}>
      ...
      <ul className={styles.indent10}>
        <li className={styles.indent20}>By email: help@micollego.io</li>
      </ul>
    </div>
  );
}
